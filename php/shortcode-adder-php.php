...
function zc_shortCodeAdder($attr, $content, $tag) {
                        ...
                        *:before {
                        ...
                        <script type='text/javascript'>
                            ...
                            function zc_action_builder_simple(buttonRef,response_type) {
                                ...
                                console.log(jQuery('#form_email_input_'+id,me))
                                ...
                                if(response_type == 'simple_form_response') {
                                    ...
                                    if(lname != '') {
                                        contactxml += \"<fl val='Phone'>\" + lname + \"</fl>\";
                                    }
                                    if(phone != '') {
                                        contactxml += \"<fl val='Last Name'>\" + phone + \"</fl>\";
                                    }
                                    contactxml += \"</xml>\";
                                    url += contactxml;
    ...
    elseif ($formType == 'z') {
        ...
        if (isset($dbshortcodeval['zoho_form'])) {
            ...
            $formValue = "<style>
                            #THANKSPAGE table,td,th{
                                border:0px !important;
                            }
                        </style><script type=\"text/javascript\">
                            var opt_jQuery = jQuery.noConflict();
                            opt_jQuery(document).ready( function($) {
                            var brClr = opt_jQuery(\"#CONTACT_EMAIL\").css(\"border-left-color\");
                                opt_jQuery(\"#fieldBorder\").val(brClr);   
                            
                                //Before submit, if you want to trigger your event, \"include your code below\" 
                                _setOptin(false,function(){
                                //include your code is here.
                                });
                            });
                        </script>
        <script type='text/javascript' src='https://campaigns.zoho.com/js/jquery-1.11.0.min.js'></script>
        <script type='text/JavaScript' src='https://campaigns.zoho.com/js/resource.js'></script>
        <script type='text/JavaScript' src='https://campaigns.zoho.com/js/subscribe.js'></script>
        <script type='text/JavaScript' src='https://campaigns.zoho.com/js/zccommon.js'></script>
        <script type='text/JavaScript' src='https://campaigns.zoho.com/js/zcoptin.js'></script>
        <script type='text/javascript' src='https://campaigns.zoho.com/js/util.js'></script>
        <script type=\"text/javascript\" src='https://campaigns.zoho.com/js/ui.datepicker.js'  charset=\"utf-8\"></script>" . $formValue;
            return $formValue;
        } else {
            $tag = '[' . $tag . ']';
            return $tag;
