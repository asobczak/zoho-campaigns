        ...
        <div style="display:none">
            <form action="options.php" method="post" id="zc4wp_a_apikey" autocomplete="off">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr id="form_page_link_tr" style="display:none;width:100%"><td width="180">To Procced:</td><td><a href="admin.php?page">Create Forms</a></td><td></td></tr>
                </table>
...
function zc_zcplugin_form_script() {
    ...
    wp_enqueue_script( 'zc_signupform_script7','https://campaigns.zoho.com/js/subscribe.js', array(),'1.0.0',false);
    wp_enqueue_script( 'zc_signupform_script8','https://campaigns.zoho.com/js/zccommon.js', array(),'1.0.0',false);
    wp_enqueue_script( 'zc_signupform_script9','https://campaigns.zoho.com/js/zcoptin.js', array(),'1.0.0',false);
    wp_enqueue_script( 'zc_signupform_script10','https://campaigns.zoho.com/js/util.js', array(),'1.0.0',false);
    wp_enqueue_script( 'zc_signupform_script11','https://campaigns.zoho.com/js/ui.datepicker.js', array(),'1.0.0',false);
}
        ...
        <div name="form_all" id="form_all_<?php echo $sno; ?>" style="display:none;">
                <div name="container" id="simple_form_div_<?php echo $sno; ?>" >                                            
                                                                                                                                ...
                                                                                                                                <div id="title_color_picker_div_<?php echo $sno; ?>" style="position:relative;display:none;">
                                                                                                                                        <div  class="zcfloat" >
                                                                                                                                                <input style="display:none;" type="text" id="title_bgval_<?php echo $sno; ?>" value="
                                                                                                                                                        <?php
                                                                                                                                                                if ($dbshortcodeval != '' && trim($dbshortcodeval['title_bg_val']) != '') {
                                                                                                                                ...
                                                                                                                                <div id="label_color_picker_div_<?php echo $sno; ?>" style="position:relative;display:none;" >
                                                                                                                                        <div class="zcfloat" >
                                                                                                                                                <input style="display:none;" type="text" id="label_bgval_<?php echo $sno; ?>" value="
                                                                                                                                                        <?php
                                                                                                                                                                if ($dbshortcodeval != '' && trim($dbshortcodeval['label_bg_val']) != '') {
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                                ...
                                                                                                                                <div style="position:relative;display:none;" id="field_color_picker_div_<?php echo $sno; ?>">
                                                                                                                                        ...
                                                                                                                                        <input style="display:none;" type="text" id="field_bgval_<?php echo $sno; ?>" value="
                                                                                                                                                <?php
                                                                                                                                                        if ($dbshortcodeval != '' && trim($dbshortcodeval['field_bg_val']) != '') {
                                                                                                                                ...
                                                                                                                                <div id="buton_color_picker_div_<?php echo $sno; ?>" style="position:relative;display:none;">
                                                                                                                                        <div class="zcfloat"  >
                                                                                                                                                <input style="display:none;" type="text" id="buton_bgval_<?php echo $sno; ?>" value="
                                                                                                                                                        <?php
                                                                                                                                                                if ($dbshortcodeval != '' && trim($dbshortcodeval['buton_bg_val']) != '') {
                                                                                                                                ...
                                                                                                                                <div id="bgcol_color_picker_div_<?php echo $sno; ?>" style="position:relative;display:none;">
                                                                                                                                        <div class="zcfloat" >
                                                                                                                                                <input style="display:none;" type="text" id="bgcol_bgval_<?php echo $sno; ?>" value="
                                                                                                                                                        <?php
                                                                                                                                                                if ($dbshortcodeval != '' && trim($dbshortcodeval['bgcol_bg_val']) != '') {
                                                                                                                                ...
                                                                                                                                <div style="position:relative">
                                                                                                                                        <div id="hedbg_color_picker_div_<?php echo $sno; ?>" class="zcfloat" style="display:none;" >
                                                                                                                                                <input style="display:none;" type="text" id="hedbg_bgval_<?php echo $sno; ?>" value="
                                                                                                                                                        <?php
                                                                                                                                                                if ($dbshortcodeval != '' && trim($dbshortcodeval['forbg_bg_val']) != '') {
                                                                                                                                ...
                                                                                                                                <div style="position:relative">
                                                                                                                                        <div id="borbg_color_picker_div_<?php echo $sno; ?>" class="zcfloat" style="display:none;" >
                                                                                                                                                <input style="display:none;" type="text" id="borbg_bgval_<?php echo $sno; ?>" value="
                                                                                                                                                        <?php
                                                                                                                                                                if ($dbshortcodeval != '' && trim($dbshortcodeval['borbg_bg_val']) != '') {
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                        ...
                                                                                                                        <td width="500px;">
                                                                                                                                <div class="zcsilderMain zcsliderpd0" style="width:250px;">
                                                                                                                                        ...
                                                                                                                                        <script type="text/javascript">zc_uiSliderChangeSetter('<?php echo $sno; ?>')</script>
                                                                                                                                </div>
                                                                                                                        </td>
                                                                                                                </tr>
                                                                                                        </table>
                                                                                        ...
                                                                                        <div style="background-color:#fff;border:solid 1px rgb(207, 207, 207);width:350px;" id="total_form_child_<?php echo $sno; ?>">
                                                                                                ...
                                                                                                <div id="form_body_container_<?php echo $sno; ?>" style="background-color:#fff;">
                                                                                                        ...
                                                                                                        <div style=" padding:10px 15px; text-align:center; margin-bottom:10px;">
                                                                                                                <input type="button" class="button button-primary" style="box-shadow: none;background-color:#e07070;font-family:Arial; font-size:14px; color:#fff; border:solid 1px #e07070; border-radius:5px;background-image:initial" value="Subscribe Now" id="form_button_<?php echo $sno; ?>"/>
                                                                                                        </div>
                                                                                                </div>
                                                                                        </div>
                                                                                <?php
                        ...
                        <div class="zcbtncntr" style="display:none;" id="save_cancel_button_div_<?php echo $sno; ?>"> 
                                <button onclick="return zc_editorContentChecker(this,'1','<?php echo $apiKeyVal; ?>','<?php echo $id; ?>');" class="zcnewbuttonWP" id="simple_button_<?php echo $sno; ?>" style="box-shadow: none;margin-right:15px;">
                ...
                <div name="zohoform" style="display:none;padding:30px;" id="zoho_form_div_<?php echo $sno; ?>">
                        ...
                        <div id="zcform_save_button_<?php echo $sno; ?>" class="zcbtncntr">
                                <br/>
                                <button onclick="return zc_editorContentChecker(this,'2','<?php echo $apiKeyVal; ?>','<?php echo $id; ?>');" class="zcnewbuttonWP" id="zcform_button_<?php echo $sno; ?>" style="background-image:initial;box-shadow: none;margin-right:15px;">
                                    <span>Save Changes</span>
...
?>
                ...
                <div id="saved_list_content" style="padding:0px;">
                        <div class="zctright zcmt15">
                            <button class=" zcnewbuttonWP" id="new_mailing_button" onclick="zc_createNewForm();">
                                New sign-up form
                            </button>
                        </div>
                                        ...
                                        <tr>
                                                <td id="zc_form"width="48%" align="left" valign="top">
                                                        ...
                                                        <div class="zcmt20" align="center">
                                                                <button id="zoho_form_shower" class="zcnewbuttonWP">
                                                                        Proceed
                                                                </button>
                                                        </div>
                                                </td>
                                                ...
                                                <td id="local_form" width="48%" align="left" valign="top">
                                                        ...
                                                        <div class="zcmt20">
                                                                <button id="simple_form_shower" class="zcnewbuttonWP">
                                                                        Create
                                                                </button>
                                                        </div>
                                                </td>
...
?>
            <div class="zcwelcomepansf" id="welcome_container">
                ...
                <div class="zcbtncntr">
                    <input type="button" value="Go to Welcome Page" class="zcnewbuttonWP" onclick="window.location = 'admin.php?page=custompage'">
                </div>
            </div>
<?php
        }
